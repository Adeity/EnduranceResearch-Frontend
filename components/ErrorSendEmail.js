export default function ErrorSendEmail(props) {
    return (
        <>
            <h6>Nastala chyba. Můžete nám ji zaslat na email pavelpa2@fel.cvut.cz</h6>
            <form action="mailto:pavelpa2@fel.cvut.cz?subject=VO dotazníky chyba" method="post" encType="text/plain">
                <input className={"form-control form-control-danger text-danger"} type="text" readOnly={true} name="Chybova_hlaska" value={props.errorMessage} />
